...
import 'package:jobsque/Message/send%20menu.dart';
...
class _ChatDetailPageState extends State<ChatDetailPage> {
  ...
  List<ChatMessage> chatMessage = [
    ChatMessage(message: "Hi Mr Omar EL Badry (Goat)", type: MessageType.Receiver),
    ChatMessage(message: "Hope you are doin good", type: MessageType.Receiver),
    ChatMessage(message: "Good, and you?", type: MessageType.Sender),
    ChatMessage(message: "I'm fine, We would like to hire you", type: MessageType.Receiver),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: DefaultAppBar("Chat", context),
      body: Stack(
        children: <Widget>[
