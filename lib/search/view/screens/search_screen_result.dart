...
import 'package:jobsque/search/view/screens/search_screen_not_found.dart';
import '../../../home/view/widgets/recent_job_item.dart';
import '../../../shimmer/shimmer_recently_jobs_list_view.dart';
        ...
        BlocBuilder<SearchCubit, SearchState>(
          builder: (context, state) {
            ...
            if (state is SearchLoaded) {
              return Column(
                children: [
                  DefaultHeader('Featuring ${cubit.foundResults.length} jobs'),
                  Padding(
